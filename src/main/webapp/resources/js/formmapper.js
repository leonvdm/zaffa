;(function($, window, document, undefined){
  ...
  var defaults = {
    ...
    country: "za",
    map: true, //A selector, a jQuery object or a DOM element. Default: false which shows no map.
    ...
    location: true, //Location to initialize the map on. Default is false shows a blank map.
	satelliteOnZoom: false, //Switch to satellite view when zoomed in. Default: false
	findme: true, //Ask user access to their location. Default: false
